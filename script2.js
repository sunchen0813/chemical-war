...
function startCountDown(duration, element) {
    ...
    let countInterval = setInterval(function (c) {
        ...
        if(secondsRemaining>0&&endgame==false)secondsRemaining = secondsRemaining - 1;
            ...
            document.getElementById('endgame1').innerHTML='<p id="endgame"></p><p id="endgamecontent">遊戲結束</p><a href="index.html"><input id="endgamebutton" type="button" value="回首頁"></input></a>';
        } 
        if(minerspace==9)minersec=0;
        ...
        if(fightsec%60==59&&enemyspace<5)produceenemy();
